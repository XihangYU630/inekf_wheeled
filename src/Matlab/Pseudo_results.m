...
% Enc_only_res = readmatrix('Data2\Parking\pseudo_encoder.csv');
Enc_only_res = readmatrix('Data2\Parking\data_convergence_1.csv');
...
figure(2)
sgtitle('\textbf{Slip-Robust Encoder-Pseudo Measurements InEKF State Vector Convergence}','fontsize', 2*fsize, 'Interpreter','latex');
subplot(7,3,1)
hold on
