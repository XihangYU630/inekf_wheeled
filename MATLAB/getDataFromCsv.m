function [GPS,IMU,CAMERA,ENCODER] = getDataFromCsv()
    ...
    CAMERA.Position.X = camera_mat(:,2); CAMERA.Position.Y = camera_mat(:,2); CAMERA.Position.Z = camera_mat(:,3);
    CAMERA.Orientation.X = camera_mat(:,2); CAMERA.Orientation.Y = camera_mat(:,2); CAMERA.Orientation.Z = camera_mat(:,3);
    ...
    IMU.Gyroscope.X = imu_mat(:,2); IMU.Gyroscope.Y = imu_mat(:,3); IMU.Gyroscope.Z = imu_mat(:,4);
